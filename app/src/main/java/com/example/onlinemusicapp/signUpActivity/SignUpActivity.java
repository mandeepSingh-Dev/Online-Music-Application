package com.example.onlinemusicapp.signUpActivity;
...
import com.example.onlinemusicapp.databinding.ActivitySignUpBinding;
...
public class SignUpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*FirebaseDatabase.getInstance().getReference().child("Users").setValue("HELOOOJDBVHD").addOnSuccessListener(new OnSuccessListener<Void>() {
            @Override
            public void onSuccess(Void unused) {
                Log.d("SUCCEESS","SUCCEESS");
                Toast.makeText(SignUpActivity.this,"SUCCEESS",Toast.LENGTH_SHORT).show();
            }
            ...
            public void onCanceled() {
                ...
                Toast.makeText(SignUpActivity.this,"onCanceled",Toast.LENGTH_SHORT).show();
    ...
    public void signUpAndStoreDetails() {
        Log.d("singnUpbutClicked","CLICKED");
            ...
            public void onClick(View v) {
                ...
                if (!validateEmail() | !validatePassword()) {
                    ...
                    if (password.equals(confirmpassword) && (!Name.isEmpty())) {
                        ...
                        Log.d("jvhdj",mreference.toString()+"f");
                        ...
                        mreference.addValueEventListener(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull @NotNull DataSnapshot snapshot) {
                                ...
                                for (DataSnapshot snapshot1 : snapshot.getChildren()) {
                                    ...
                                    Log.d("EEMMMMMMMMMMMAILS",emails);
                            ...
                            public void onCancelled(@NonNull @NotNull DatabaseError error) {
                                Log.d("ERRORDDFDF",error.getDetails()+"\n"+error.getMessage());
