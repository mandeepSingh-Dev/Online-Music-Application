...
import com.example.onlinemusicapp.MusicRecylerView.MyAdapter3
...
import com.example.onlinemusicapp.MyViewModel.*
import com.example.onlinemusicapp.R
import com.example.onlinemusicapp.StorageReferenceSingleton
import com.example.onlinemusicapp.databinding.FolderFeaturedArtistLayoutBinding
import com.example.onlinemusicapp.databinding.FolderLayoutNormalBinding
import com.example.onlinemusicapp.databinding.FragmentOnlineMusicBinding
import com.example.onlinemusicapp.databinding.ListTrendingLayoutBinding
...
class OnlineMusicFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        _binding?.includeTrendingEnglish?.InLanguageTextView?.setOnClickListener {
            var bundle = Bundle()
        ...
        _binding?.includeTrendingPunjabi?.InLanguageTextView?.setOnClickListener {
            var bundle = Bundle()
            bundle.putString("Playlist", "Trending_Playlist")
            bundle.putString("Folder", "Punjabi")
            navController?.navigate(R.id.action_onlineMusicFragment_to_songsFragment, bundle)
        }
        _binding?.includeTrendingHindi?.InLanguageTextView?.setOnClickListener {
            var bundle = Bundle()
            bundle.putString("Playlist", "Trending_Playlist")
        ...
        set_Arraylist_ToTrendingLayoutsDUPLICATE(
            mRefernce!!,
            "Trending_Playlist",
            "English",
            _binding?.includeTrendingEnglish!!
        )
        set_Arraylist_ToTrendingLayoutsDUPLICATE(
            mRefernce!!,
            "Trending_Playlist",
            "Punjabi",
            _binding?.includeTrendingPunjabi!!
        )
        set_Arraylist_ToTrendingLayoutsDUPLICATE(
            mRefernce!!,
            "Trending_Playlist",
            "Hindi",
            _binding?.includeTrendingHindi!!
        )
...
if (arrlist != null) {
    ...
    fun foldersArtistOnClickedListened(
        folderLayoutNormalBinding: FolderFeaturedArtistLayoutBinding,
        playlist: String,
        folder: String
    ) {
        folderLayoutNormalBinding?.folderLayout.setOnClickListener {
    ...
    fun setUp_MoodFolders(view: View) {
        ...
        foldersOnClickedListened(
            _binding?.include90sAndEarly!!,
            "Moods&Collection",
            "90s&Early2000s"
        )
    ...
    //new fundtion
    fun set_Arraylist_ToTrendingLayoutsDUPLICATE(
        refernce: StorageReference,
        playlistName: String,
        folderName: String,
        view: ListTrendingLayoutBinding
        ...
        if (folderName.equals("English")) {
            viewmodelEnglish = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModel_TrendEnglish::class.java)
            ...
            viewmodePunjabi = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModel_TrendPunjab::class.java)
            viewmodePunjabi?.getLiveList()?.observe(viewLifecycleOwner, Observer {
                settingTrendPlaylists(it, view)
            })
        } else {
            viewmodelHindi = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModel_TrendHindi::class.java)
    ...
    fun settingTrendPlaylists(it: ArrayList<Songs_FireBase>, view: ListTrendingLayoutBinding) {
        for (i in 0..it.size - 1) {
            ...
            it.get(i).storageMetadataa.addOnSuccessListener {
                ...
                when (i) {
                    0 -> {
                        view.songName1.setText(songName)
    ...
    fun setImageToFeaturedArtist(
        playlistName: String,
        artistName: String,
        artistlayout: FolderFeaturedArtistLayoutBinding
    )/*= withContext(Dispatchers.Main)*/ {
        if (artistName.equals("Ammy Virk")) {
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelAmmyVirk::class.java)
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelAmritMaan::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelAnnieMarie::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelApDhillon::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelArijit::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelCamila::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelDiljit::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelDilpreet::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelDuaLipa::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelGurnaamBhullar::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelJasonDeurlo::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelJustinBeiber::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelKishoreKumar::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelManinder::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelNehaKakkar::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelPostMalone::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelShivjot::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelWeeknd::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
            ...
            var viewModel = ViewModelProvider(
                this,
                ViewModelProvider.AndroidViewModelFactory.getInstance(activity?.application!!)
            ).get(ViewModelTonesAndI::class.java)
            viewModel.getLiveBitmap()?.observe(viewLifecycleOwner, Observer {
                /*_binding?.includeAmmyVirk?.singerImage?.setImageBitmap(it)*/
                artistlayout?.singerImage?.setImageBitmap(it)
            })
