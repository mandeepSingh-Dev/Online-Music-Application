...
class ViewModelShivjot(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Shivjot")?.child("shivjot.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Shivjot"
