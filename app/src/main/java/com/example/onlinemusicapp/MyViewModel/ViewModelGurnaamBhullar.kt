...
class ViewModelGurnaamBhullar(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Gurnaam Bhullar")?.child("gurnaam bhullar.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Gurnaam Bhullar"
