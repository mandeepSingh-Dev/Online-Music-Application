...
class ViewModelDilpreet(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Dilpreet Dhillon")?.child("dilpreet dhilon.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Dilpreet Dhillon"
