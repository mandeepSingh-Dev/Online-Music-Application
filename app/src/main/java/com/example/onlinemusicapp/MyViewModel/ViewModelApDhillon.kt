...
class ViewModelApDhillon(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Ap Dhillon")?.child("AP-dhillon-wallpapers-7.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Ap Dhillon"
