...
class ViewModelDuaLipa(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Dua Lipa")?.child("dua lipa.jpg")?.downloadUrl?.addOnSuccessListener {

            liveArtistName?.value="Dua Lipa"
