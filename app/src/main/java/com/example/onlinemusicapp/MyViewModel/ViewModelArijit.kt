...
class ViewModelArijit(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Arijit_Singh")?.child("arijit singh.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Arijit_Singh"
