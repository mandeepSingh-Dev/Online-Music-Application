...
class ViewModelWeeknd(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("The_Weekend")?.child("the weekend.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="The Weekend"
