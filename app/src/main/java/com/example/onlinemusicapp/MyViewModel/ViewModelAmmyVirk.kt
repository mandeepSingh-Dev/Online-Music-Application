...
class ViewModelAmmyVirk(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Ammy Virk")?.child("ammyvirkimage.jpg")?.downloadUrl?.addOnSuccessListener {

            liveArtistName?.value="Ammy Virk"
