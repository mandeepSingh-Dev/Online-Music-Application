...
class ViewModelJasonDeurlo(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Jason Derulo")?.child("jason derulo.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Jason Derulo"
