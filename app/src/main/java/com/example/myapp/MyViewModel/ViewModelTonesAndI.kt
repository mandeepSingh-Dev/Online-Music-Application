...
class ViewModelTonesAndI(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Tones and I")?.child("tones and i.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Tones and I"
