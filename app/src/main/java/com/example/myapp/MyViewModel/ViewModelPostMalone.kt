...
class ViewModelPostMalone(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Post_Malone")?.child("post malone.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Post_Malone"
