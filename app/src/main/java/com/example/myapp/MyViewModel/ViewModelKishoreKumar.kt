...
class ViewModelKishoreKumar(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Kishore Kumar")?.child("kishore_Kumar.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Kishore Kumar"
