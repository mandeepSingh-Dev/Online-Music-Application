...
class ViewModelManinder(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Maninder Buttar")?.child("maninder.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Maninder Buttar"
