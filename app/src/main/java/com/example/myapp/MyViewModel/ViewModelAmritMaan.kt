...
class ViewModelAmritMaan(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Amrit Maan")?.child("amrit_maan-6.jpg")?.downloadUrl?.addOnSuccessListener {

            liveArtistName?.value="Amrit Maan"
