...
class ViewModelKygo(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Kygo")?.child("kygo.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Kygo"
