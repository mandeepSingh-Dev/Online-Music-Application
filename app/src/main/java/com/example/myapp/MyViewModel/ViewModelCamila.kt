...
class ViewModelCamila(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Camila Cabillo")?.child("camilla cabillo.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Camila Cabillo"
