...
class ViewModelJustinBeiber(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Justin Beiber")?.child("justin beiber.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Justin Beiber"
