...
class ViewModelNehaKakkar(application: Application):AndroidViewModel(application)
{
    ...
    init {
        ...
        mrefernceSingleton?.child("Featured_Artists")?.child("Neha_Kakkar")?.child("neha kakkr.jpg")?.downloadUrl?.addOnSuccessListener {
            liveArtistName?.value="Neha_Kakkar"
